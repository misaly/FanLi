...
namespace FanLi.Common
{
    public class DNTRequest
    {
        ...
        /// <summary>
        /// 接收 requst 或 get,  返回Int
        /// </summary>
        /// <param name="strName"></param>
        /// <returns></returns>
        public static int GetStringToInt(string strName, int id)
        {
            int tempInt = id;
            string req = GetQueryString(strName);
            if (req != "")
            {
                try { tempInt = int.Parse(req); }
                catch { return tempInt; }
            }
        ...
        /// <summary>
        /// 接收 requst 或 post,  返回Int
        /// </summary>
        /// <param name="strName"></param>
        /// <returns></returns>
        public static int GetFromToInt(string strName, int id)
        {
            int tempInt = id;
            string req = GetFormString(strName);
            if (req != "")
            {
                try { tempInt = int.Parse(req); }
                catch { return tempInt; }
        ...
        /// </summary>
        /// <param name="strName">参数</param>
        /// <param name="defaultvalue">是否进行SQL安全检查</param>
        /// <returns>Url或表单参数的值</returns>
