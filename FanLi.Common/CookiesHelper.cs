    ...
    public class CookiesHelper
    {
        ...
        public static string GetCookieValue(string cookieName, string key)
        {
            ...
            if (request != null)
            {
                ...
                {
                    string cookieName2 = ", " + cookieName;
                    if (request.Cookies[cookieName2] != null)
                    {
                        if (!string.IsNullOrEmpty(key) && request.Cookies[cookieName2].HasKeys)
                        {
                            return request.Cookies[cookieName2].Values[key];
                        }
                        else
                        {
                            return request.Cookies[cookieName2].Value;
                        }
                    }
                    else
                    {
        ...
        public static void AddCookie(HttpCookie cookie)
        {
            if (cookie != null)
            {
                ...
                //cookie.Domain = HospitalKeys._DOMAIN;
