...
namespace FanLi.Common
{
    public class Utils
    {
        ...
        public static string CutString(string str, int len, string p_TailString)
        {
        ...
        /// <returns></returns>
        public static string GetWebRequest(string postUrl, string postType, string postData)
        {
            try
            {
        ...
        /// <param name="jsonStr"></param>
        /// <returns></returns>
        public static int GetJsonCount(string jsonStr)
        {
            JObject json = (JObject)JsonConvert.DeserializeObject(jsonStr);
            return json.Count;
        }
        ...
        /// <param name="jsonStr"></param>
        /// <returns></returns>
        public static JObject GetJson(string jsonStr)
        {
        ...
        /// <returns></returns>
        public static string GetJsonValue(string key, JObject json)
        {
            string jsonvalue = "";
            if (json != null)
            {
        ...
        public static string FormatDate(string dataTime1, string dateMode)
        {
            string result = "";
            if (!string.IsNullOrEmpty(dataTime1))
            {
                result = FormatDate(Convert.ToDateTime(dataTime1), dateMode);
            }
            return result;
        }
        #endregion
        ...
        public static string replace_adress(string str)
        {
            str = str.Replace("维吾尔自治区", "").Replace("壮族自治区", "").Replace("回族自治区", "").Replace("特别行政区", "").Replace("自治县", "").Replace("自治区", "").Replace("自治州", "").Replace("地区", "").ToString().TrimEnd('省').TrimEnd('市').TrimEnd('县').TrimEnd('区');
            return str;
        }
    }
}
